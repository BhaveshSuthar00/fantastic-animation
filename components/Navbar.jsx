    ...
    return ( 
        <div className=" w-full m-auto fixed top-1 py-1 z-40 mt-2">
            <div className="flex justify-space-between w-w85 items-center bg-black text-white p-2 m-auto rounded-2xl">
                <div className="ml-3">
                    <img src={'zoi.png'} width={30} height={30} alt="logo"/>
                    {/* Logo  left hand logo */}
                </div>
                <div className="w-1/5 flex justify-between px-3 py-3 ml-3 md:w-1/2 max-[550px]:w-full max-[775px]:w-2/4 2xl:w-1/5 xl:w-1/5">
                    {/* center menu list */}
                    <Link href="#Home">Home</Link>
                    <Link href="#AboutUs">About Us</Link>
                    <Link href="#ContactUs">Contact Us</Link>
                </div>
                <div className="ml-auto mr-3 max-[431px]:hidden">
